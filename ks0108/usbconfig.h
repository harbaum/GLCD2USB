...
#define	USB_CFG_DEVICE_ID		0x25, 0x05
 ...
 */
#define	USB_CFG_VENDOR_NAME	'w','w','w','.','h','a','r','b','a','u','m','.','o','r','g','/','t','i','l','l','/','g','l','c','d','2','u','s','b'
 ...
 */
#define	USB_CFG_DEVICE_NAME		'G','L','C','D','2','U','S','B'
#define	USB_CFG_DEVICE_NAME_LEN	8
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros.
 */
#define	USB_CFG_DEVICE_CLASS	0   /* specified at interface level */
